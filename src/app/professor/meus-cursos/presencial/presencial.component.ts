...
@Component({
  ...
  `],
  selector: 'mt-meus-cursos-presencial',
  templateUrl: './presencial.component.html'
})

export class ProfessorMeusCursosPresencialComponent implements OnInit {
  IMG_URL = environment.img_url
  cursos: Curso[]
  categorias: Categoria[]

  constructor(private cursosService: CursosService, private configuracoesStore: ConfiguracoesStore,
  ...
  ngOnInit() {
    ...
    try {
      ...
      this.cursosService.getCursosPresenciaisPorProfessor(1).subscribe((ApiResponse) => {
