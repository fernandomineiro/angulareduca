...
@Component({
  ...
  `],
  selector: 'mt-meus-cursos-online',
  templateUrl: './online.component.html'
})

export class ProfessorMeusCursosOnlineComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    try {
      ...
      this.cursosService.getCursosOnlinePorProfessor(1).subscribe((ApiResponse) => {
